...
import requests
from components.GenText import generate_script, parse_script
from components.GetImgPex import fetch_pexels_images
...
def create_clip_from_image(scene_text, images_per_scene = 1, output_audio_path="temp_audio.mp3", resolution = (854, 480)):
    ...
    if not image_url:
        ...
        return [ColorClip(size=resolution, color=(0,0,0))]
